...
void setup_scr_screen_3(lv_ui *ui)
{
	...
	ui->screen_3_chart_1 = lv_chart_create(ui->screen_3);
	lv_chart_set_type(ui->screen_3_chart_1, LV_CHART_TYPE_BAR);
	lv_chart_set_div_line_count(ui->screen_3_chart_1, 3, 5);
	lv_chart_set_point_count(ui->screen_3_chart_1, 5);
	lv_chart_set_range(ui->screen_3_chart_1, LV_CHART_AXIS_PRIMARY_Y, 0, 100);
	...
	lv_chart_series_t * screen_3_chart_1_0 = lv_chart_add_series(ui->screen_3_chart_1, lv_color_hex(0x000000), LV_CHART_AXIS_PRIMARY_Y);
	lv_chart_set_next_value(ui->screen_3_chart_1, screen_3_chart_1_0, 1);
	lv_chart_set_next_value(ui->screen_3_chart_1, screen_3_chart_1_0, 20);
	lv_chart_set_next_value(ui->screen_3_chart_1, screen_3_chart_1_0, 30);
	lv_chart_set_next_value(ui->screen_3_chart_1, screen_3_chart_1_0, 40);
	lv_chart_set_next_value(ui->screen_3_chart_1, screen_3_chart_1_0, 5);
	lv_obj_set_pos(ui->screen_3_chart_1, 0, 0);
	lv_obj_set_size(ui->screen_3_chart_1, 128, 128);
	lv_obj_set_scrollbar_mode(ui->screen_3_chart_1, LV_SCROLLBAR_MODE_OFF);

	//Write style for screen_3_chart_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_3_chart_1, 222, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_3_chart_1, lv_color_hex(0x2F92DA), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_3_chart_1, 1, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_3_chart_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->screen_3_chart_1, lv_color_hex(0xe8e8e8), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_side(ui->screen_3_chart_1, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_line_color(ui->screen_3_chart_1, lv_color_hex(0xe8e8e8), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_3_chart_1, &lv_font_montserratMedium_16, LV_PART_TICKS|LV_STATE_DEFAULT);
