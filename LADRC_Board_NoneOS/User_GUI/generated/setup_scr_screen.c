...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_color(ui->screen_cont_1, lv_color_hex(0x2F35DA), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0xb4ff00), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_btn_1, lv_color_hex(0xb4ff00), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_btn_1, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_btn_1, lv_color_hex(0x2F35DA), LV_PART_MAIN|LV_STATE_DEFAULT);
