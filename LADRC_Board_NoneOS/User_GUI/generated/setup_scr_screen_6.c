...
void setup_scr_screen_6(lv_ui *ui)
{
	...
	lv_arc_set_angles(ui->screen_6_arc_2, 0, 90);
	...
	lv_arc_set_angles(ui->screen_6_arc_3, 0, 180);
	...
	lv_arc_set_angles(ui->screen_6_arc_4, 0, 270);
	...
	lv_label_set_text(ui->screen_6_btn_1_label, "MOTOR1");
	...
	lv_obj_set_pos(ui->screen_6_btn_1, 17, 26);
	lv_obj_set_size(ui->screen_6_btn_1, 37, 10);
	...
	lv_label_set_text(ui->screen_6_btn_2_label, "MOTOR2");
	...
	lv_obj_set_pos(ui->screen_6_btn_2, 72, 26);
	lv_obj_set_size(ui->screen_6_btn_2, 37, 10);
	...
	lv_label_set_text(ui->screen_6_btn_3_label, "MOTOR3");
	...
	lv_obj_set_pos(ui->screen_6_btn_3, 17, 87);
	lv_obj_set_size(ui->screen_6_btn_3, 37, 10);
	...
	lv_label_set_text(ui->screen_6_btn_4_label, "MOTOR4");
	...
	lv_obj_set_pos(ui->screen_6_btn_4, 72, 87);
	lv_obj_set_size(ui->screen_6_btn_4, 37, 10);
