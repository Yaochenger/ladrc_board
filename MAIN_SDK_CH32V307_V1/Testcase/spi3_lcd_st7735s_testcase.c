/**
 * @file spi3_lcd_st7735s_testcase.c
 * @brief SPI3 + ST7735S LCD test case.
 */
...
/**
 * @brief Draw ASCII 16x8 font with foreground/background colors.
 */
void Gui_DrawFont_GBK16(u16 x, u16 y, u16 fc, u16 bc, u8 *s)
{
    unsigned char i;
