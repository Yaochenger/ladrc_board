...
#define     ERROR_TEXT          CSI(31) "ERROR(%d) %s:" CSI(39)    /**< 错误标签 */
#define     WARNING_TEXT        CSI(33) "WARNING(%d) %s:" CSI(39)  /**< 警告标签 */
#define     INFO_TEXT           CSI(32) "INFO(%d) %s:" CSI(39)     /**< 信息标签 */
#define     DEBUG_TEXT          CSI(34) "DEBUG(%d) %s:" CSI(39)    /**< 调试标签 */
#define     VERBOSE_TEXT        CSI(36) "VERBOSE(%d) %s:" CSI(39)  /**< 冗余信息标签 */
#else
